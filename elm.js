...
var _satellite_of_love$ordina$Main$onEnter = function (msg) {
...
var _satellite_of_love$ordina$Main$drawLabels = function (labels) {
...
var _satellite_of_love$ordina$Main$diagram = 'elmprogram.png';
var _satellite_of_love$ordina$Main$init = {
	ctor: '_Tuple2',
	_0: {
		newLabel: '',
		labels: {
			ctor: '::',
			_0: {text: 'CodeStar', x: 100, y: 10},
			_1: {ctor: '[]'}
		},
...
var _satellite_of_love$ordina$Main$Model = F3(
	function (a, b, c) {
		return {newLabel: a, labels: b, lastClick: c};
	});
var _satellite_of_love$ordina$Main$Label = F3(
	function (a, b, c) {
		return {text: a, x: b, y: c};
	});
var _satellite_of_love$ordina$Main$FocusFieldNotFound = function (a) {
	return {ctor: 'FocusFieldNotFound', _0: a};
};
var _satellite_of_love$ordina$Main$Click = function (a) {
	return {ctor: 'Click', _0: a};
};
var _satellite_of_love$ordina$Main$subscriptions = function (model) {
	return _elm_lang$mouse$Mouse$clicks(_satellite_of_love$ordina$Main$Click);
};
var _satellite_of_love$ordina$Main$SaveLabel = function (a) {
	return {ctor: 'SaveLabel', _0: a};
};
var _satellite_of_love$ordina$Main$NewLabel = function (a) {
	return {ctor: 'NewLabel', _0: a};
};
var _satellite_of_love$ordina$Main$newLabelInput = function (model) {
	...
	if (_p2.ctor === 'Nothing') {
		...
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_satellite_of_love$ordina$Main$NewLabel),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(model.newLabel),
						_1: {
							ctor: '::',
							_0: _satellite_of_love$ordina$Main$onEnter(
								_satellite_of_love$ordina$Main$SaveLabel(
...
var _satellite_of_love$ordina$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									'url(',
									A2(_elm_lang$core$Basics_ops['++'], _satellite_of_love$ordina$Main$diagram, ')'))
							},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
			...
			_1: {
				ctor: '::',
				_0: _satellite_of_love$ordina$Main$drawLabels(model.labels),
				_1: {
					ctor: '::',
					_0: _satellite_of_love$ordina$Main$newLabelInput(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _satellite_of_love$ordina$Main$NoOp = {ctor: 'NoOp'};
var _satellite_of_love$ordina$Main$requestFocus = function (field_id) {
	var handle = function (result) {
		var _p5 = result;
		if (_p5.ctor === 'Ok') {
			return _satellite_of_love$ordina$Main$NoOp;
		} else {
			return _satellite_of_love$ordina$Main$FocusFieldNotFound(_p5._0._0);
		}
	};
	return A2(
...
var _satellite_of_love$ordina$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'NoOp':
			...
			case 'Click':
				return {
					...
					_1: _satellite_of_love$ordina$Main$requestFocus('newLabel')
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _satellite_of_love$ordina$Main$main = _elm_lang$html$Html$program(
	{init: _satellite_of_love$ordina$Main$init, view: _satellite_of_love$ordina$Main$view, update: _satellite_of_love$ordina$Main$update, subscriptions: _satellite_of_love$ordina$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _satellite_of_love$ordina$Main$main !== 'undefined') {
    _satellite_of_love$ordina$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SaveLabel":["Main.Label"],"FocusFieldNotFound":["String"],"NewLabel":["String"],"NoOp":[],"Click":["Mouse.Position"]}}},"aliases":{"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Main.Label":{"args":[],"type":"{ text : String, x : Int, y : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
